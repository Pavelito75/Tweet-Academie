...
<body class="dark:bg-neutral-900 dark:text-neutral-300 w-screen h-screen">
  <div class="flex justify-between w-4/5 m-auto h-full gap-8">
      <nav id="left" class="w-1/4 flex flex-col justify-between">
        <img src="" alt="Logo" class="bg-blue-500 w-16 h-16 mb-3 mt-2">
        <ul class="flex flex-col gap-9 text-2xl select-none">
          ...
          <a href="/account" class="flex gap-6 items-center cursor-pointer hover:bg-neutral-700 rounded-full p-3 pl-6"><img src="/assets/Icons/add_a_photo.png" alt="Profil Home" class="w-8 h-8"><p class="h-fit">Profil</p></a>
        </ul>
        <div>
          ...
          <div class="flex my-8 gap-3 px-6 py-3 rounded-full  cursor-pointer hover:bg-neutral-700">
            <img src="/assets/Icons/verified.png" alt="Picture image" class="w-12 h-12">
